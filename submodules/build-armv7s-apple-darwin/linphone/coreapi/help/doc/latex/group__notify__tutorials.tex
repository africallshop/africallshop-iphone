...
This program is a {\itshape very} simple usage example of liblinphone. It demonstrates how to listen to a S\-I\-P subscription. It then sends notify requests back periodically. first argument must be like sip\-:{\tt jehan@sip.\-linphone.\-org} , second must be password . \par
