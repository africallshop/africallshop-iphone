...
- (void)viewDidLoad {
    ...
    
    {
        ...
        [historyButton setTitleColor:LINPHONE_MAIN_COLOR forState:(UIControlStateHighlighted | UIControlStateSelected)];
...
- (IBAction)onHistoryClick:(id)event {
     [historyButton setTitleColor:LINPHONE_MAIN_COLOR forState: UIControlStateSelected];
    [[PhoneMainView instance] changeCurrentView:[HistoryViewController compositeViewDescription]];
}

- (IBAction)onContactsClick:(id)event {
    
    [contactsButton setTitleColor:LINPHONE_MAIN_COLOR forState: UIControlStateSelected];
...
- (IBAction)onSettingsClick:(id)event {
    [settingsButton setTitleColor:LINPHONE_MAIN_COLOR forState: UIControlStateSelected];
    [[PhoneMainView instance] changeCurrentView:[SettingsViewController compositeViewDescription]];
}

- (IBAction)onChatClick:(id)event {
    [chatButton setTitleColor:LINPHONE_MAIN_COLOR forState: UIControlStateSelected];
