...
- (void)viewDidLoad {
    ...
    [linphoneButton setBackgroundImage:[UIImage imageNamed:@"contacts_all_selected.png"]
    ...
    [linphoneButton setTitle:@"AfriCallShop"
					forState:UIControlStateNormal];
...
- (void)changeView:(HistoryView)view {
	...
	[ContactSelection setEmailFilter:FALSE];
        //[tableController loadData];
        [tableController loadAfricallShopContact];
