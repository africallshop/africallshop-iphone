...
//    [buttonItem release];
    ...
    UIBarButtonItem *buttonItem = [[UIBarButtonItem alloc] initWithTitle:NSLocalizedString(@"Log out", nil) style:UIBarButtonItemStyleBordered target:self action:@selector(onLogOutClick:)];
    self.navigationItem.rightBarButtonItem = buttonItem;
    [buttonItem release];
}
...
- (IBAction)onLogOutClick: (id)sender {
    ...
    [[NSUserDefaults standardUserDefaults] removeObjectForKey:@"firsPasswd"];
    ...
    [[NSUserDefaults standardUserDefaults] removeObjectForKey:@"domain"];
    [[NSUserDefaults standardUserDefaults] removeObjectForKey:@"callerId"];
